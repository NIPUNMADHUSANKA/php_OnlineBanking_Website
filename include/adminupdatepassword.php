<html>
    ...
    <body>
        ...
        <div class="aboutheader">
            <h1 class="aboutheadertitle" style="text-transform:uppercase;">Update Password</h1>
        </div>
        ...
        <h2 class='userregisterform'>Update password form</h2>
            <label class='lbl'>Update Password</label>
            <br>
            <hr style='width:20rem;color:#ccc;'>
            
            <input type='text' name='oldadminpassword' class='ent'  autocomplete='false' required placeholder="Your Old Password">
            <br>
            <input type='text' name='newadminpassword' class='ent'  autocomplete='false' required placeholder="Your New Password">
            <br>
            <input type='text' name='cnewadminpassword' class='ent'  autocomplete='false' required placeholder="Confirm Your New Password">
            <br>
            <button name="updateadminpassword"  class="btn btn_save">Update</button>
