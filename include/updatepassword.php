<html>
    ...
    <body>
        ...
        <h2 class='userregisterform'>Update password form</h2>
            ...
            <input type='text' name='oldpassword' class='ent'  autocomplete='false' required placeholder="Your Old Password">
            <br>
            <input type='text' name='newpassword' class='ent'  autocomplete='false' required placeholder="Your New Password">
            <br>
            <input type='text' name='cnewpassword' class='ent'  autocomplete='false' required placeholder="Confirm Your New Password">
            <br>
            <button name="updatepassword"  class="btn btn_save">Update</button>
