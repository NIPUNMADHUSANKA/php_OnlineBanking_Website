<html>
    ...
    <body>
        ...
        <div class="aboutheader">
            <h1 class="aboutheadertitle" style="text-transform:uppercase;">Admin details form</h1>
        </div>
        ...
        $auname= $_SESSION['adminname'];
        $sql="SELECT * FROM admin WHERE Username='$auname'";
        $result=$conn->query($sql);
        $row=$result->fetch_assoc();
        
        echo"<h2 class='userregisterform'>admin details form</h2>
            ...
            <br>
            <hr style='width:20rem;color:#ccc;'>
            <input type='text' name='' class='ent'  autocomplete='false' required value='".$row['LName']."' disabled>
            <br>
