    ...
    <body>
        <div class="nav">
                 ...
                 <div class="menu">
                    ...
                    <li><a class="col1 colsub" onclick="slideshow1()">Reports</a></li>
                    ...
                    <ul class="submenu2" id="check-class1" style="height:110px;">
                    <li><a href="admincustomerreport.php" class="col1">Customer Report</a></li>
                    <li><a href="adminreport.php" class="col1">Admin Report</a></li>
                    <li><a href="adminalltransactionreport.php" class="col1">All Transaction Report</a></li>
                    <li><a href="admintransferrequestreport.php" class="col1">Transfer Request Report</a></li>
                    </ul>
                 </div>          
        </div>
        <div class="aboutheader">
            <h1 class="aboutheadertitle" style="text-transform:uppercase;">admin registration form</h1>
        </div>
        ...
        <h2 class="userregisterform">admin registration form</h2>
