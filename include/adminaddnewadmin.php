<html>
    ...
    <body>
        ...
        <hr style="width:20rem;color:#ccc;">
       <br>
        <input type="text" name="LName" id="" class="ent" placeholder="Full Name" autocomplete="false" required>
        <br>
        ...
        <br>
        <button name="addadmindeatails"  class="btn btn_save">SUBMIT</button>
        </form>
        <center>
        </p>
        </div>
