<html>
    ...
    <body>
        ...
        <div class="aboutheader">
            <h1 class="aboutheadertitle" style="text-transform:uppercase;">Login</h1>
        </div>
        ...
        <h2 class="userregisterform">Login to your Account</h2>
            <label class="lbl">Account, Login Site</label>
            <br>
                <hr style="width:20rem;color:#ccc;">
        
            <br>
            <input type="text" name="customerloginusername" id="" class="ent" placeholder="Your Username Or UserId" autocomplete="false" required>
            <br>
            <input type="password" name="customerloginpassword" id="" class="ent" placeholder="Password" autocomplete="false" required>
            <br>
            <button name="customerlogin"  class="btn btn_save">SUBMIT</button>
        </form>
        </center>
        </p>
        </div>
