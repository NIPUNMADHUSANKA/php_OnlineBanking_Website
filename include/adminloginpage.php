<html>
    ...
    <body>
        ...
        <div class="aboutheader">
            <h1 class="aboutheadertitle" style="text-transform:uppercase;">Admin Login</h1>
        </div>
        ...
        <h2 class="userregisterform">Login to Admin Account</h2>
            <label class="lbl">Admin Account, Login Site</label>
            <br>
                <hr style="width:20rem;color:#ccc;">
        
            <br>
            <input type="text" name="adminusername" id="" class="ent" placeholder="Admin Username Or UserId" autocomplete="false" required>
            <br>
            <input type="password" name="adminpassword" id="" class="ent" placeholder="Password" autocomplete="false" required>
            <br>
            <button name="adminlogin"  class="btn btn_save">SUBMIT</button>
        </form>
        <center>
        </p>
        </div>
